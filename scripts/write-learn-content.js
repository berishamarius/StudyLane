...
// New learn-content with educational descriptions and keyPoints per folder
const content = `(function () {
  window.LEARN_SOURCES = {
    core: {
      math: ['Khan Academy', 'OpenStax Mathematics', 'GeoGebra'],
      physics: ['OpenStax University Physics', 'PhET Simulations (U Colorado)', 'MIT OpenCourseWare Physics'],
      chemistry: ['Chemistry LibreTexts', 'Royal Society of Chemistry', 'OpenStax Chemistry 2e'],
      biology: ['OpenStax Biology 2e', 'HHMI BioInteractive', 'NCBI Bookshelf'],
      cs: ['CS50 Harvard', 'MIT OpenCourseWare CS', 'MDN Web Docs'],
      engineering: ['MIT OpenCourseWare Engineering', 'NPTEL (IITs)', 'Open Textbook Library'],
      medicine: ['MedlinePlus', 'WHO Learning Academy', 'PubMed'],
      law: ['Cornell Law LII', 'EUR-Lex', 'UN Treaty Collection'],
      economics: ['CORE Econ', 'OpenStax Economics', 'World Bank Open Learning'],
      socialScience: ['OECD Education', 'Our World in Data', 'UNESCO Institute for Statistics'],
      writing: ['Purdue OWL', 'Open Textbook Library', 'Saylor Academy'],
      earthScience: ['NASA STEM', 'USGS Education', 'NOAA Education'],
      geography: ['National Geographic Education', 'UN Data', 'World Bank Data'],
      languageArts: ['British Council Learn English', 'Deutsche Welle Learn German', 'Cambridge Dictionary'],
      languageLearning: ['Institut français', 'Instituto Cervantes', 'Goethe-Institut'],
      arts: ['The Met Museum Learning', 'Google Arts & Culture', 'Smarthistory'],
      health: ['WHO', 'CDC', 'NHS Health A-Z'],
      architecture: ['MIT OpenCourseWare Architecture', 'RIBA', 'ArchDaily'],
      agriculture: ['FAO e-Learning Academy', 'USDA Education', 'CIMMYT'],
      cybersecurity: ['NIST Cybersecurity', 'ENISA', 'CISA'],
      businessPolicy: ['IMF', 'ILO', 'OECD Policy'],
      energy: ['IEA', 'IRENA', 'US Dept of Energy'],
      ocean: ['NOAA Oceans', 'UNESCO Oceanographic Commission', 'WHOI']
    },
    school: [
      {
        id: 'mathematics',
        ...
        folders: [
          {
            ...
            topics: ['Linear equations', 'Functions', 'Polynomials'],
            sourceGroup: 'math'
          },
          {
            name: 'Geometry',
            ...
            topics: ['Angles and triangles', 'Coordinate geometry', 'Transformations'],
            sourceGroup: 'math'
          },
          {
            ...
            topics: ['Data visualization', 'Probability rules', 'Distributions'],
            sourceGroup: 'math'
          },
          {
            name: 'Trigonometry',
            ...
            topics: ['Sine cosine tangent', 'Right triangle problems', 'Unit circle basics'],
            sourceGroup: 'math'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Motion', 'Forces', 'Energy and work'],
            sourceGroup: 'physics'
          },
          {
            ...
            topics: ['Circuits', 'Current and voltage', 'Magnetic fields'],
            sourceGroup: 'physics'
          },
          {
            ...
            topics: ['Sound', 'Light', 'Lenses and mirrors'],
            sourceGroup: 'physics'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Atoms', 'Periodic table', 'Bonding'],
          ...
          },
          {
            ...
            topics: ['Balancing equations', 'Reaction rates', 'Stoichiometry'],
            sourceGroup: 'chemistry'
          },
          {
            ...
            topics: ['pH scale', 'Neutralization', 'Titration basics'],
            sourceGroup: 'chemistry'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Cell structure', 'Mitosis and meiosis', 'DNA and RNA'],
            sourceGroup: 'biology'
          },
          {
            name: 'Human Biology',
            ...
            topics: ['Body systems', 'Nutrition', 'Homeostasis'],
            sourceGroup: 'biology'
          },
          {
            name: 'Ecology',
            ...
            topics: ['Ecosystems', 'Food webs', 'Climate impact'],
            sourceGroup: 'biology'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Algorithms', 'Decomposition', 'Abstraction'],
            sourceGroup: 'cs'
          },
          {
            name: 'Programming',
            ...
            topics: ['Variables and loops', 'Functions', 'Debugging'],
            sourceGroup: 'cs'
          },
          {
            ...
            topics: ['Networks', 'Cybersecurity basics', 'Data representation'],
            sourceGroup: 'cs'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            helps: ['Read once for gist, then re-read for detail.', 'Annotate key lines before answering questions.', 'Compare two interpretations using evidence from the text.'],
          ...
          },
          {
            ...
            helps: ['Draft with a simple outline: intro, body, conclusion.', 'Write one paragraph at a time.', 'Use a checklist for grammar, structure, and evidence.'],
          ...
          },
          {
            ...
            helps: ['Practice 10 vocabulary words per session.', 'Transform sentences between tenses.', 'Use new words in your own examples.'],
        ...
        folders: [
          {
            ...
            topics: ['Ancient civilizations', 'Industrial era', 'Global conflicts'],
          ...
          },
          {
            ...
            topics: ['Source evaluation', 'Bias detection', 'Context analysis'],
            sourceGroup: 'socialScience'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Landforms', 'Weather systems', 'Natural hazards'],
          ...
          },
          {
            ...
            topics: ['Population', 'Urbanization', 'Migration'],
            sourceGroup: 'geography'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Supply and demand', 'Market structures', 'Consumer behavior'],
          ...
          },
          {
            ...
            topics: ['Budgeting', 'Interest rates', 'Saving and credit'],
            sourceGroup: 'economics'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Rock cycle', 'Plate tectonics', 'Earthquakes'],
          ...
          },
          {
            ...
            topics: ['Solar system', 'Stars and galaxies', 'Space exploration'],
            sourceGroup: 'earthScience'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Nutrition', 'Sleep', 'Physical activity'],
            sourceGroup: 'health'
          },
          {
            name: 'Mental Health',
            ...
            topics: ['Stress management', 'Help resources', 'Healthy habits'],
            sourceGroup: 'health'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Drawing', 'Color theory', 'Composition'],
            sourceGroup: 'arts'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Rhythm and meter', 'Scales and harmony', 'Notation'],
            sourceGroup: 'arts'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Endurance', 'Strength', 'Mobility'],
            sourceGroup: 'health'
          }
        ]
      }
    ...
    university: [
      {
        ...
        folders: [
          ...
          },
          {
            ...
            topics: ['Vectors and matrices', 'Linear transformations', 'Eigenvalues'],
            sourceGroup: 'math'
          },
          {
            name: 'Statistics and Probability',
            ...
            topics: ['Probability distributions', 'Statistical inference', 'Regression analysis'],
            sourceGroup: 'math'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['Newtonian mechanics', 'Conservation laws', 'Rotational motion'],
            sourceGroup: 'physics'
          },
          {
        ...
        folders: [
          {
            ...
            topics: ['Arrays and lists', 'Sorting algorithms', 'Big-O complexity'],
            sourceGroup: 'cs'
          },
          {
            name: 'Databases',
            ...
            topics: ['SQL', 'Relational data models', 'Query optimisation'],
            sourceGroup: 'cs'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['GDP and growth', 'Inflation and deflation', 'Fiscal and monetary policy'],
            sourceGroup: 'economics'
          }
        ]
      },
        ...
        folders: [
          {
            ...
            topics: ['DNA replication', 'Transcription and translation', 'Gene regulation'],
            sourceGroup: 'biology'
          },
          {
            ...
            topics: ['Mendelian genetics', 'Population genetics', 'Natural selection'],
            sourceGroup: 'biology'
          }
        ]
      }
...
fs.writeFileSync('pages/learn/learn-content.js', content, 'utf8');
console.log('learn-content.js written:', content.length, 'chars');
